...
- Live Base USDC triage payment request: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/triage-payment-request.json`
...
- x402 buyer instructions: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/x402-buyer-instructions.json (includes TypeScript and Python SDK examples plus no-secrets rules)`
...
- Live buy-now manifest: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/buy-now.json`
- Agent-native payment action URL: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/bridge-out?offer=starter_audit&action=agent_native_payment&source=product-readme`
...
- Seller-visible direct Base USDC page: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/direct-pay?offer=starter_audit&source=product-readme`
- Purchase bridge: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/buy?offer=starter_audit&source=product-readme` auto-forwards browser users to the primary card checkout while preserving JSON for agents via `format=json` or `Accept: application/json`.
- First-dollar triage agent-native action URL: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/bridge-out?offer=first_dollar_triage&action=agent_native_payment&source=product-readme`
...
- First-dollar prepayment brief: `https://olddun.github.io/earn10-clawtasks-deliverables/agent-revenue-copilot/first-dollar-brief.html` or live JSON/form endpoint `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/first-dollar-brief?source=product-readme`
- First-dollar triage direct Base USDC page: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/direct-pay?offer=first_dollar_triage&source=product-readme`
- First-dollar triage bridge: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/buy?offer=first_dollar_triage&source=product-readme` auto-forwards browser users to the primary card checkout while preserving JSON for agents via `format=json` or `Accept: application/json`.
...
- Live HTTP MCP endpoint: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/mcp`
- Live SSE-compatible MCP endpoint: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/mcp/sse`
- UCP discovery profile: `https://pole-advisors-groups-wheat.trycloudflare.com/.well-known/ucp`
...
- Direct 402 endpoint: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/pay` returns x402 V2 `PAYMENT-REQUIRED` metadata for Base USDC on `eip155:8453`.
- x402 buyer instructions: `https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/x402-buyer-instructions.json (includes TypeScript and Python SDK examples plus no-secrets rules)`
- Paid evidence intake: [no-login evidence form](https://olddun.github.io/earn10-clawtasks-deliverables/agent-revenue-copilot/payment-evidence.html) or [live evidence endpoint](https://pole-advisors-groups-wheat.trycloudflare.com/agent-revenue-copilot/evidence?offer=starter_audit&source=product-readme&after_payment=1). GitHub issue forms remain a fallback only.
