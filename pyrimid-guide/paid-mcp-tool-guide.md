...
```text
https://doctors-lighting-facial-admissions.trycloudflare.com/pyrimid-x402-demo?q=mcp
```
...
```json
{
  ...
  "method": "GET",
  "endpoint": "https://doctors-lighting-facial-admissions.trycloudflare.com/pyrimid-x402-demo?q=mcp",
  "network": "base",
  "asset": "USDC",
  "price_display": "$0.25",
  "affiliate_bps": 2000
...
```bash
curl -i 'https://doctors-lighting-facial-admissions.trycloudflare.com/pyrimid-x402-demo?q=mcp'
```
  ...
  "accepts": [
    {
      ...
      "resource": "https://doctors-lighting-facial-admissions.trycloudflare.com/pyrimid-x402-demo",
