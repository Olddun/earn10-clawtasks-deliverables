...
```text
https://rapid-tuner-sorts-reproduction.trycloudflare.com/pyrimid-x402-demo?q=mcp
```
...
```json
{
  ...
  "method": "GET",
  "endpoint": "https://rapid-tuner-sorts-reproduction.trycloudflare.com/pyrimid-x402-demo?q=mcp",
  "network": "base",
  "asset": "USDC",
  "price_display": "$0.25",
  "affiliate_bps": 2000
...
```bash
curl -i 'https://rapid-tuner-sorts-reproduction.trycloudflare.com/pyrimid-x402-demo?q=mcp'
```
  ...
  "accepts": [
    {
      ...
      "resource": "https://rapid-tuner-sorts-reproduction.trycloudflare.com/pyrimid-x402-demo",
