...
function primaryPurchaseChoices() {
  return {
    ...
    first_action: "Human/operator buyers should use card_payment_action_url first, pay through final_card_checkout, which prepares a concrete MCPlug purchase id and auto-forwards to tracked Stripe/card checkout, then submit receipt/order id only after payment succeeds. Wallet-capable agents can use agent_native_payment_action_url.",
